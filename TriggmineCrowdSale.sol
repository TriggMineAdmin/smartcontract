...
contract MileStoneCrowdSale {
    ...
    function setPreSaleFirstTwoDaysMileStone(uint256  _startDate, uint256 _endDate) public validDate(_startDate, _endDate){
    ...
    function setPreSaleThirdDayMileStone(uint256 _startDate, uint256 _endDate) public validDate(_startDate, _endDate){
        mileStones.push(Milestone(_startDate, _endDate, TriggmineLibrary.SaleStates.PreSaleThirdDay));
    }

    function setPreSaleFourthDayMileStone(uint256 _startDate, uint256 _endDate) public validDate(_startDate, _endDate){
        mileStones.push(Milestone(_startDate, _endDate, TriggmineLibrary.SaleStates.PreSaleFourthDay));
    }

    function setPreSaleFifthDayMileStone(uint256 _startDate, uint256 _endDate) public validDate(_startDate, _endDate){
        mileStones.push(Milestone(_startDate, _endDate, TriggmineLibrary.SaleStates.PreSaleFifthDay));
    }

    function setPreSaleSixthDayMileStone(uint256 _startDate, uint256 _endDate) public validDate(_startDate, _endDate){
        mileStones.push(Milestone(_startDate, _endDate, TriggmineLibrary.SaleStates.PreSaleSixthDay));
    }

    function setPreSaleLastDaysMileStone(uint256 _startDate, uint256 _endDate) public validDate(_startDate, _endDate){
        preSaleEndDate = _endDate;
        mileStones.push(Milestone(_startDate, _endDate, TriggmineLibrary.SaleStates.PreSaleLastDays));
    }

    function setMainSaleFirstThreeDaysMileStone(uint256 _startDate, uint256 _endDate) public validDate(_startDate, _endDate){
    ...
    function setMainSaleFourthSeventhDaysMileStone(uint256 _startDate, uint256 _endDate) public validDate(_startDate, _endDate){
        mileStones.push(Milestone(_startDate, _endDate, TriggmineLibrary.SaleStates.MainTokenSaleFourthSeventhDays));
    }

    function setMainSaleLastDaysMileStone(uint256 _startDate, uint256 _endDate) public validDate(_startDate, _endDate){
...
contract TriggmineCrowdSale is MileStoneCrowdSale, Ownable {
    ...
    /* Number of available tokens 100 mlns */
    uint256 public constant AVAILABLE_TOKENS = 1e8;
    ...
    /* Oracle Wallet */
    address public constant oracle = 0x9d8f9c02e4bc9feac038f1fe4cb02c1e6626c2a2;
    ...
    function finalize() onlyOwner public {
        ...
        if (isSoftCapReached()) {
            ...
            setSpecialRoleBonus(fixedAdviserAddress_1, fixedAdviserPercent, 1000); /*0.5%*/
            setSpecialRoleBonus(fixedAdviserAddress_2, fixedAdviserPercent, 1000); /*0.5%*/
    ...
    function refund() onlyOracle public {
        require(isFinalized);
        require(!isSoftCapReached());
    ...
    function destroy() onlyOracle public {
        selfdestruct(owner);
    }
    ...
    function setSpecialRoleBonus(address roleAddress, uint256 bonus, uint256 divisor) realAddress(roleAddress) internal{
        ...
        uint256 tokensAmount = getTokenRaised().mul(bonus).div(divisor);
        token.mint(roleAddress, tokensAmount);
        TokenPurchase(roleAddress, tokensAmount, bonus, TriggmineLibrary.Currencies.NONE);
    }

    function getEarlyInvestorBonus(uint256 weiAmount) returns (uint256){
        uint256 bonus = 0;
